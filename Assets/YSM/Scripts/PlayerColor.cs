...
namespace YSM
{
    ...
    public class ColorTransform :MonoBehaviour
    {
        ...
        static public Color EnumToColor(PlayerColorType index)
        {
            ...
            switch (idx)
            {
                case (int)PlayerColorType.BLACK:            return new Color32(0, 0, 0, 1);
                case (int)PlayerColorType.GRAY:             return new Color32(127, 127, 127, 1);
                case (int)PlayerColorType.RED_THICK:        return new Color32(136, 0, 21, 1);
                case (int)PlayerColorType.RED:              return new Color32(237, 28, 36, 1);
                case (int)PlayerColorType.ORANGE:           return new Color32(255, 127, 39, 1);
                case (int)PlayerColorType.YELLOW:           return new Color32(255, 242, 0, 1);
                case (int)PlayerColorType.GREEN:            return new Color32(34, 177, 76, 1);
                case (int)PlayerColorType.BLUE:             return new Color32(0, 162, 232, 1);
                case (int)PlayerColorType.NAVY:             return new Color32(63, 72, 204, 1);
                case (int)PlayerColorType.PURPLE:           return new Color32(163, 73, 164, 1);
                case (int)PlayerColorType.WHITE:            return new Color32(255, 255, 255, 1);
                case (int)PlayerColorType.GRAY_LIGHT:       return new Color32(195, 195, 195, 1);
                case (int)PlayerColorType.BROWN:            return new Color32(185, 122, 87, 1);
                case (int)PlayerColorType.PINK:             return new Color32(255, 174, 201, 1);
                case (int)PlayerColorType.GOLD:             return new Color32(255, 201, 14, 1);
                case (int)PlayerColorType.YELLOW_LIGHT:     return new Color32(239, 228, 176, 1);
                case (int)PlayerColorType.LIME:             return new Color32(181, 230, 29, 1);
                case (int)PlayerColorType.BLUE_LIGHT:       return new Color32(153, 217, 234, 1);
                case (int)PlayerColorType.GRAY_BLUE:        return new Color32(112, 146, 190, 1);
                case (int)PlayerColorType.PURPLE_LIGHT:     return new Color32(200, 191, 231, 1);
